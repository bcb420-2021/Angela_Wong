...
genes from the not differentially expressed ones. The code in the chunk below is 
not completely my own work.
```{r}
# re-organize the order of the genes in differential_results to match the order
# in the expression data. Without this step, the differentially expressed genes 
# will be a blob on the plot because the order does not match
differential_results_copy <- differential_results[rownames(expData), ]
...
**There was 1086 GO biological process (GO:BP) terms, 46 KEGG terms, 46 Reactome 
(REAC) terms, and 24 WikiPathways (WP) terms out of the 5193 differentially 
expressed significant genes. This data includes the ambiguous genes that have 
GO annotations.**
![](A2_Figures/all.png)

**Without the ambiguous genes, the results are actually different, which was 
interesting. The number of terms increased for all the data sources: 1116 GO:BP 
terms, 49 KEGG terms, 47 REAC terms, and 25 WP terms.**
...
Out of the 2482 genes, there were 139 GO:BP terms, 2 KEGG terms, 2 REAC terms, 
and no WP terms (143 terms overall). This includes the ambiguous genes.**
![](A2_Figures/upregulated.png)

**Excluding the ambiguous genes, the number of KEGG, REAC, and WP terms did not 
change. Only GO:BP terms changed from 139 to 155 terms, adding up to 159 terms 
in total.**
...
Out of the 2711 genes, there were 997 GO:BP terms, 39 KEGG terms, 61 REAC terms, 
and 21 WP terms (1118 terms overall). This includes the ambiguous genes.**
![](A2_Figures/downregulated.png)

**Excluding the ambiguous genes, the number of KEGG and WP terms did not change. 
The GO:BP and REAC terms changed from 997 to 1008 terms and from 61 to 65 terms, 
respectively, which adds up to 1133 terms in total.**
